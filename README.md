...
Preparar y limpiar el conjunto de datos educativo mediante técnicas de preprocesamiento que incluyen manejo de nulos, eliminación de duplicados, codificación categórica, normalización y selección de variables.
Ajustar modelos de clasificación usando Regresión Logística, Random Forest y XGBoost, entrenados para estimar la probabilidad de deserción e identificar patrones asociados al abandono académico.
Evaluar y comparar el rendimiento de los modelos mediante validación cruzada estratificada, priorizando el recall para la clase de deserción y complementando con precisión y F1-score.
Analizar la interpretabilidad del modelo mediante SHAP sobre el modelo final para identificar la contribución de cada variable a la predicción de deserción.
Segmentar a los estudiantes en niveles de riesgo (alto, medio, bajo) basándose en las probabilidades estimadas, para facilitar la identificación de estudiantes en riesgo y apoyar intervenciones institucionales diferenciadas.
---
3. Dataset
Fuente
...
Curva ROC — Tasa de Verdaderos Positivos vs. Tasa de Falsos Positivos con anotación del AUC
Curva Precisión-Recall — Precisión vs. Recall a través de umbrales con anotación del AUC-PR
Curva de Calibración — Probabilidades predichas vs. proporciones reales de deserción (10 intervalos), comparada con la diagonal ideal
Archivos generados:
...
Genera:
Gráfico beeswarm — Dirección y distribución del impacto de cada variable en todas las observaciones de prueba
Gráfico de barras — Top 15 variables ordenadas por valor absoluto medio SHAP
